...
System.register(['app/plugins/sdk', './css/multistat-panel.css!', 'lodash', 'jquery', 'jquery.flot', './external/d3', 'moment'], function (_export, _context) {
  "use strict";

  var MetricsPanelCtrl, _, $, d3, moment, _createClass, MultistatPanelCtrl;
              ...
              if (horizontal) {
                ...
                if (groupCol >= 0) {
                  ...
                  this.groupedRows.sort(function (a, b) {
                    ...
                    if (aPos == bPos) return a.key.localeCompare(b.key);else return aPos - bPos;
                  });
