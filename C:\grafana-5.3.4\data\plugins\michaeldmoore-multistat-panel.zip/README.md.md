...
In the event that the database cannot pre-filter the data in this way, the aggregation setting can still generate the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ4NjYyNDMwNiwxODEyNDc5ODczLC0yNj
